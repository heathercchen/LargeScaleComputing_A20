...
def sim_gpu_nvdi():
  ...
  plt.imsave('ps_q3_serial_tile10.png', nvdi_s)
  ...
  plt.imsave('ps_q3_gpu_tile10.png', nvdi_gpu)

  #Report the time for serial solution and gpu
  print('The time using serial solution (10 times): {0:.4f} seconds'.format(serial_time))
  print('The time using gpu (10 times): {0:.4f} seconds'.format(gpu_time))
